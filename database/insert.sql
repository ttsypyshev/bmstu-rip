...
INSERT INTO users (name, login, password, is_admin) VALUES
('Timofei Tsypyshev', 'admin1', 'password123', TRUE),
(NULL, 'user1', 'userPass123', FALSE),
(NULL, 'user2', 'securePass456', FALSE),
(NULL, 'user3', 'myPassword789', FALSE);
...
Масштабируемость: COBOL поддерживает большие объемы данных и может обрабатывать сложные бизнес-логику.',
 FALSE);
